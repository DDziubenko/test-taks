...
export const ConfirmationModal = ({
	...
	return (
		<div className="fixed w-full h-full inset-0 z-50 flex items-center justify-center p-20">
			<div
				className="absolute inset-0 bg-[#1B1B1B4D] backdrop-blur-sm"
				onClick={onClose}
			/>

			<div className="relative bg-white w-full  rounded-[16px] py-8 px-8 flex flex-col gap-[120px]">
				<button
					onClick={onClose}
				...
				<div className="flex justify-center">
					<h2 className="font-medium text-[40px] text-[#31393C] text-center">
				...
				<div className="flex gap-8 justify-center">
					...
					>
						{t('confirmationModal.useOldFilter')}
					</Button>
					<Button
						variant="primary"
						onClick={onConfirm}
						className="w-full max-w-[280px]"
					>
						{t('confirmationModal.applyNewFilter')}
					</Button>
				</div>
			</div>
		</div>
